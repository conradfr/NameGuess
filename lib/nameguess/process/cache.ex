defmodule NameGuess.Cache do
  ...
  def set_divisions(%Space{} = space, divisions) do
  ...
  def increment_games_counter(%Space{} = space) do
  ...
  def has_people_counter(%Space{} = space, gender \\ nil) do
  ...
  def get_people_counter(%Space{} = space, gender \\ nil) do
    counter_atom = get_people_counter_atom(space, gender)
