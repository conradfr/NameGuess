defmodule NameGuess.People do
  ...
  @spec filter_no_overloading(People, Space) :: map
  ...
  defp filter_no_overloading(people, space) do
  ...
  def get_keys_total(space, nil) do
  ...
  def get_keys_total(space, gender) do
  ...
  def random_keys(space, 1, :all) do
    get_keys(space)
    |> Enum.random()
  end

  def random_keys(space, how_many, gender) do
